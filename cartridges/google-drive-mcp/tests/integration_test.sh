...
# Integration tests for google-drive-mcp cartridge.
set -euo pipefail
...
echo "=== google-drive-mcp integration tests ==="
...
if command -v idris2 &>/dev/null; then
    cd "$CART_DIR/abi" && idris2 --check GoogleDriveMcp/SafeRegistry.idr 2>&1
    echo "  ABI: OK"
else
...
echo ""
echo "All tests passed for google-drive-mcp!"
