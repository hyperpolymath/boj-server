...
//
// echidna-llm-mcp/adapter/echidna_llm_adapter.zig
//
...
const REST_PORT: u16 = 9229;
const GRPC_PORT: u16 = 9230;
const GQL_PORT:  u16 = 9231;
...
fn dispatch(tool: []const u8, _body: []const u8, resp: []u8) Response {
    _ = _body;
    if (std.mem.eql(u8, tool, "echidna_init")) {
        return .{ .status = 200, .body = okJson(resp, "echidna_init forwarded") };
    }
    if (std.mem.eql(u8, tool, "echidna_authenticate")) {
        return .{ .status = 200, .body = okJson(resp, "echidna_authenticate forwarded") };
    }
    if (std.mem.eql(u8, tool, "echidna_suggest_tactics")) {
        return .{ .status = 200, .body = okJson(resp, "echidna_suggest_tactics forwarded") };
    }
    if (std.mem.eql(u8, tool, "echidna_rank_provers")) {
        return .{ .status = 200, .body = okJson(resp, "echidna_rank_provers forwarded") };
    }
...
fn dispatchGraphql(body: []const u8, resp: []u8) Response {
    if (std.mem.indexOf(u8, body, "echidna_init") != null)
        return dispatch("echidna_init", body, resp);
    if (std.mem.indexOf(u8, body, "echidna_authenticate") != null)
        return dispatch("echidna_authenticate", body, resp);
    if (std.mem.indexOf(u8, body, "echidna_suggest_tactics") != null)
        return dispatch("echidna_suggest_tactics", body, resp);
    if (std.mem.indexOf(u8, body, "echidna_rank_provers") != null)
        return dispatch("echidna_rank_provers", body, resp);
