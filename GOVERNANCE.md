...
This document describes the governance model for **Bundle of Joy Server**.

---

## Project Governance Model

Bundle of Joy Server follows a **Benevolent Dictator For Life (BDFL)** governance model.
