...
Replace all {{PLACEHOLDER}} values with your information:
  Bundle of Joy Server     - Your project name
  ...
  https://github.com/hyperpolymath/boj-server          - Your website/domain
...
- This repository (`hyperpolymath/boj-server`) and all its code
...
When using Bundle of Joy Server, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/boj-server/security/advisories)
...
*Thank you for helping keep Bundle of Joy Server and its users safe.* 🛡️
