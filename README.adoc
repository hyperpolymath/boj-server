...
image:https://img.shields.io/badge/License-MPL_2.0--3.0--or--later-blue.svg[License: MPL-2.0,link="LICENSE"]
...
* *Cartridges* — 125 pluggable cartridges across Teranga / Shield / Ayo trust tiers

== Scope

*125 cartridges*, organised across the domains below. Each cartridge is a formally verified Idris2 ABI + Zig FFI + Deno/JS adapter triple, reachable through a single MCP endpoint.
