...
Optional:
* https://www.idris-lang.org/[Idris2] — only needed to modify ABI definitions
* https://just.systems/[just] — task runner (convenience, not required)
...
| `BOJ_QUIC`
| `1`
| Enable QUIC transport (0 = UDP only)
