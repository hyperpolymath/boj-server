...
* *MCP (Model Context Protocol)*: Full support for Claude, Cursor, and
other MCP clients
...
* *125 Cartridges*: Covering databases, git, cloud, comms, ML, browser,
and more
* *68 MCP Tools*: 45 boj_* discovery/domain tools + 23 coord_* tools;
per-cartridge operations are reachable via boj_cartridge_invoke across
the 125-cartridge catalogue
