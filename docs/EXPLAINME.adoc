...
**Location**: `panll/lib/autowire.ts` (AffineScript panel autowiring with constraint solver)
...
| *PanLL AffineScript workspace layer*
| `panll/` — AffineScript/TEA panel framework, autowiring constraint solver, 108 panels for UI
...
| `panll/` | AffineScript/TEA panel framework for UI workspace layer
|===
